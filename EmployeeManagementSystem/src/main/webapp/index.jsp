...
<a href="add.jsp" class="btn btn-primary">Add Employee</a><br><br><br>
<a href="listbtn.jsp" class="btn btn-primary">View All Employee</a><br><br><br>
<a href="listupd.jsp" class="btn btn-primary">Update Details</a><br><br><br>
<a href="listdlt.jsp" class="btn btn-primary">Delete Details</a><br><br><br>
